...
import { AllProfessorsApiCall } from '../services/userApis';
import { Button, Backdrop, Box, Modal, Fade, Typography, TextField, TableContainer, TableBody, TableHead, TableRow, Paper, Table } from '@mui/material';
...
function AllProfessorsList() {
    ...
    AllProfessorsApiCall().then((result) => { SetAllProfessors(result); }).catch((err) => { console.log(err) });

    return (<>
        <Navbar activeLink='All Profeser'/>
        <br />
            ...
            <Fade in={open}>
                <Box sx={style}>
                    ...
                    <Typography id="transition-modal-description" sx={{ mt: 2 }}>
                        ...
                        To drop the Profeser <b>{deleteUser.userId}</b>, type the UserId to confirm.
                        <br />
...
export default AllProfessorsList;
