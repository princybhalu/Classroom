                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        {pages.map((page) => (
                            <div key={page} >
                                ...
                                {/* For Teacher */}
                                {page === 'Create Classroom' && <Button onClick={() => { navigate('/'); }} sx={{ color: 'black', display: 'block' }}>Create Classroom</Button>}
                                {page === 'View Craeted Classes' && <Button onClick={() => { navigate('/'); }} sx={{ color: 'black', display: 'block' }}>View Craeted Classes</Button>}

                                {/* For Student */}
                                {page === 'All Classroom' && <Button onClick={() => { navigate('/'); }} sx={{ color: 'black', display: 'block' }}>All Classroom</Button>}
                                {page === 'Join Class' && <Button onClick={() => { navigate('/'); }} sx={{ color: 'black', display: 'block' }}>Join Class</Button>}
