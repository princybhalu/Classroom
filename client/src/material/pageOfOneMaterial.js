                    ...
                    <div className='col-9' style={{ marginLeft: '40px' }}>
                        <div className='main-title-of-material'>
                            ...
                            <Box sx={{ display: 'flex' }}>
                                ...
                                {/* Update & Delete  */}
                                {user.role === RoleName.PROFESSOR && <>  <Stack direction="row" justifyContent="end" sx={{ marginLeft: '125%' }}>
                                    <Box sx={{ flexGrow: 0 }}>
                            ...
                            <div style={{ color: 'rgb(74, 73, 73)' }}>{Material.proferserName} : {Material.createDate} {Material.updateDate !== null && <>(Edited At {Material.updateDate})</>}</div>
                        </div>
                        ...
                        <br />
                        {Material.materialObject.Attach !== undefined && <>
